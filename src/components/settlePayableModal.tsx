...
import { settlePayableAction, SettlePayableActionState } from "@/lib/api/actions/settlePayable";
...
export default function SettlePayableModal({
  ...
  const boundAction = settlePayableAction.bind(null, payment.id);
  const [state, action, pending] = useActionState<
    SettlePayableActionState,
    FormData
  >(boundAction, null);
